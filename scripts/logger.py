...
class CsvLogger:
    def __init__(self, filepath='./', filename='results.csv', data=None):
        ...
        self.fieldsnames = ['epoch', 'val_loss', 'train_loss']
    ...
    def plot_progress_errk(self, claimed_acc=None, title='RECNN', k=1):
    ...
    def plot_progress_loss(self, title='RECNN'):
        plt.figure(figsize=(9, 8), dpi=300)
    ...
    def plot_progress(self, claimed_acc1=None, claimed_acc5=None, title='RECNN'):
